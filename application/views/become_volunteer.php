...
<link href="http://code.ionicframework.com/ionicons/2.0.0/css/ionicons.min.css" rel="stylesheet" type="text/css" />    
    ...
    <?php echo form_open_multipart('client_ctrl/add_volunteer');?>
...
<div class="form-group">
    <label class="bmd-label-floating">Profession: <br></label>
...
<div class="form-group">
    <label class="bmd-label-floating">Upload a photo here: <br></label>
    <input type="file" class="form-control" id="vol_image" name="vol_image" required/>
</div><div id='state'></div>
