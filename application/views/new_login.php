    ...
    <div class="row text-center flex center v-center full-height">
        <div class="col-8 col-sm-4" style="width: 282px;height: 619px;margin: 18px;">
            <div class="form-box" style="width: 352px;">
                <form class="text-center" method="post" action="check_login">
                    <fieldset>
                        <legend style="font-size: 30px; font-weight:bold;">LOGIN</legend><img id="avatar" class="avatar round" src="<?php echo base_url('assets/img/gsk_logo.jpg ');?>" />
                        <div class="form-group">
                            <div class="input-group">
                                <!-- <div class="input-group-addon"><i class="fa fa-lock" style="color:black;";></i></div> -->
                                <input class="form-control" type="text" placeholder="UserName/LoginName" name="login_name" id="login_name" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group">
