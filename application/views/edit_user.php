...
<form method="post" action="edit_update_user">

<?php foreach ($rows as $row):?>

    <?php $split_name =  $row->name;
    
        $result = explode(" ", $split_name);
        // print_r( $result);
...
<div class="form-row">
    ...
    <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="fname" id="fname" value="<?=$result[0]?>" />
                        </div>
     </div>
     <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating"><b>Middle Name</b></label>
                          <input type="text" class="form-control" name="mname" id="mname" value="<?=$result[1]?>" />
                        </div>
     </div>
     <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating"><b>Last Name</b></label>
                          <input type="text" class="form-control" name="lname" id="lname" value="<?=$result[2]?>" />
                        </div>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="addr" name="address"  value="<?=$row->address?>"/>
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="state" name="pincode" value="<?=$row->pincode?>"/>
</div><div id='state'></div>
...
<div class="form-group">
    ...
    <select type="text" class="form-control" id="gender" name="gender" value="<?=$row->gender?>" >
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="party_name" name="party_name" value="<?=$row->party_name?>" />
</div><div id='state'></div>

<button type="submit" class="btn btn-danger name="submit" onclick="user_inserted()" >Update</button>
